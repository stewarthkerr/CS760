    ...
    for i in range(0,nTest):
        ...
        for j in range(0,nFeat):
            ...
            if len(parents) == 2:
                ...
                pypxgy = pypxgy * y2cond_prob[parent1][parentindex][j][index] / ycond_prob[parent1][parentindex]
                pnypxgny = pnypxgny * noty2cond_prob[parent1][parentindex][j][index] / notycond_prob[parent1][parentindex]
            else:
                pypxgy = pypxgy * ycond_prob[j][index]
                pnypxgny = pnypxgny * notycond_prob[j][index]
        pygx = (pypxgy)/(pypxgy+pnypxgny)
